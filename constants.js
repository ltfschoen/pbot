...
const SPREADSHEET_ID = '1Oe74ztQsKJ5A2zYLECnqEAFDOH9TleOOiaTG3goFP20';

module.exports.sheet_id =
  process.env.NODE_ENV === 'production' ? SPREADSHEET_ID : SPREADSHEET_ID;
...
module.exports.milestone_automation_trigger_users = ['@luke:matrix.parity.io'];

module.exports.milestone_notification_msg = `You've got Love from Giveth!\
...
\nYou were [dished points](https://docs.google.com/spreadsheets/d/${SPREADSHEET_ID}/edit#gid=0) in the month of %MONTH%, which means you have ETH waiting for you to collect it. To do so you'll need to create a Milestone by %DEADLINE%.\
